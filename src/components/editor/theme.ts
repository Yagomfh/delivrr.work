...
export const shadcnTheme: LexKitTheme = {
  ...
  editor: "p-4 focus:outline-none relative",
  contentEditable:
    "outline-none text-base leading-relaxed text-foreground font-system focus:outline-none",

  // Placeholder styling - absolute positioned in relative container
  placeholder: "absolute top-4 left-4 text-sm leading-relaxed select-none text-muted-foreground pointer-events-none z-0",

  // Node styles for Lexical - using Tailwind classes
  paragraph: "mb-3 leading-relaxed text-foreground text-sm",
  heading: {
  ...
  tableCellHeader:
    "border border-border p-3 text-left font-semibold bg-muted text-foreground",
  ...
  sourceView: {
    textarea: "w-full h-full p-4 bg-background border-none rounded-none font-mono text-sm resize-none focus:outline-none focus:ring-0",
  },
};
