...
function Toolbar({
  ...
  return (
    <TooltipProvider>
      <div className="flex flex-wrap items-center gap-2 pb-2 bg-transparent">
...
function HTMLSourceView({
  ...
  return (
    <Textarea
      className={shadcnTheme.sourceView?.textarea || "w-full h-full p-4 bg-background border-none rounded-none font-mono text-sm resize-none focus:outline-none focus:ring-0"}
      value={htmlContent}
...
function EditorContent({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {mode === "visual" && (
        <div className="z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border flex-shrink-0">
      ...
      <div className="relative flex-1 overflow-y-auto min-h-0">
        ...
        >
          <RichTextPlugin
            ...
            placeholder={<div className={shadcnTheme.placeholder}>Description...</div>}
